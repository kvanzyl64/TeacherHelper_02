...
export const centreNavigationLinks = [
  ...
  { href: "/centre/sessions", label: "Sessions", icon: "sessions", roles: ["owner", "admin"] },
  { href: "/billing/invoices", label: "Invoices", icon: "invoice", roles: ["owner", "admin"] },
  { href: "/billing/payments", label: "Payments", icon: "payment", roles: ["owner", "admin"] },
  { href: "/billing/receipts", label: "Receipts", icon: "receipt", roles: ["owner", "admin"] },
